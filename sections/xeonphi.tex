...
\begin{figure}
	\centering 
	\includegraphics[width=\textwidth]{../images/Schmidt/cd_netdesc_layers.jpg} 
	\caption {Unterklassen von Layer}
	\label{pic:cd_Netdesc_layers} 
\end{figure} 
\begin{figure}
	\centering 
	\includegraphics[width=\textwidth]{../images/Schmidt/cd_netdesc_fullyconnected.jpg} 
	\caption {Layertyp Fully Connected Layer}
	\label{pic:cd_Netdesc_fullyconnected} 
\end{figure} 
\begin{figure}
	\centering 
	\includegraphics[width=\textwidth]{../images/Schmidt/cd_netdesc_conv.jpg} 
	\caption {Convolutional Layer}
	\label{pic:cd_Netdesc_conv} 
\end{figure} 
\begin{figure}
	\centering 
	\includegraphics[width=\textwidth]{../images/Schmidt/cd_netdesc_maxpool.jpg} 
